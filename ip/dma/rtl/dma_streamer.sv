...
#(
  parameter bit STREAM_TYPE = 0 // 0 - Read, 1 - Write
   ...
   // Outputs
   dma_axi_req_o, dma_stream_o,
   // Inputs
   clk_i, rst_ni, dma_desc_i, dma_abort_i, dma_maxb_i, dma_axi_resp_i,
   dma_stream_i
   );
  ...
  // To/From DMA FSM
  input   dma_str_in_t                    dma_stream_i;
  output  dma_str_out_t                   dma_stream_o;   
  ...
  dma_axi_req_t dma_req_ff, next_dma_req;
