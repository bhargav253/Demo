...
module prim_sync_reqack #(
  ...
  input  logic clk_src_i,       // REQ side, SRC domain
  input  logic rst_src_ni,      // REQ side, SRC domain
  input  logic clk_dst_i,       // ACK side, DST domain
  input  logic rst_dst_ni,      // ACK side, DST domain
