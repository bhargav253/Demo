module iob
  import soc_pkg::*;  
   (
    ...
    input 		 roc__axi_arready,
    output [31:0] 	 roc__axi_araddr,
    output 		 roc__axi_arvalid,
    
    input 		 roc__axi_awready,
    output [31:0] 	 roc__axi_awaddr, 
    output 		 roc__axi_awvalid,

    input 		 roc__axi_wready,
    output 		 roc__axi_wvalid,
    output [31:0] 	 roc__axi_wdata, 
    output [3:0] 	 roc__axi_wstrb,
    
    input 		 roc__axi_bvalid,
    input [1:0] 	 roc__axi_bresp,
    output 		 roc__axi_bready,
    
    input [31:0] 	 roc__axi_rdata,
    input [1:0] 	 roc__axi_rresp, 
    input 		 roc__axi_rvalid, 
    output 		 roc__axi_rready    
   );
...
//-------------------------------------------------------------
   ...
   /*
    ...
    .src_axi_\(.*\)    (dat_axi_\1),
    .dst_axi_ar\(.*\)  ({roc__axi_ar\1,dat_ram_axi_ar\1,dat_rom_axi_ar\1}),
    .dst_axi_r\(.*\)   ({roc__axi_r\1,dat_ram_axi_r\1,dat_rom_axi_r\1}),    
    .dst_axi_aw\(.*\)  ({roc__axi_aw\1,dat_ram_axi_aw\1}),    
    .dst_axi_w\(.*\)   ({roc__axi_w\1,dat_ram_axi_w\1}),        
    .dst_axi_b\(.*\)   ({roc__axi_b\1,dat_ram_axi_b\1}),            
   ...
   axil_split #(.NUM_WR_DSTS(2),.NUM_RD_DSTS(3))
     u_dat_split (/*AUTOINST*/
		  ...
		  .dst_axi_awaddr	({roc__axi_awaddr,dat_ram_axi_awaddr}), // Templated
		  .dst_axi_awvalid	({roc__axi_awvalid,dat_ram_axi_awvalid}), // Templated
		  .dst_axi_wdata	({roc__axi_wdata,dat_ram_axi_wdata}), // Templated
		  .dst_axi_wstrb	({roc__axi_wstrb,dat_ram_axi_wstrb}), // Templated
		  .dst_axi_wvalid	({roc__axi_wvalid,dat_ram_axi_wvalid}), // Templated
		  .dst_axi_bready	({roc__axi_bready,dat_ram_axi_bready}), // Templated
		  .dst_axi_araddr	({roc__axi_araddr,dat_ram_axi_araddr,dat_rom_axi_araddr}), // Templated
		  .dst_axi_arvalid	({roc__axi_arvalid,dat_ram_axi_arvalid,dat_rom_axi_arvalid}), // Templated
		  .dst_axi_rready	({roc__axi_rready,dat_ram_axi_rready,dat_rom_axi_rready}), // Templated
		  // Inputs
		  .clk,
		  .rst_n,
		  ...
		  .dst_axi_awready	({roc__axi_awready,dat_ram_axi_awready}), // Templated
		  .dst_axi_wready	({roc__axi_wready,dat_ram_axi_wready}), // Templated
		  .dst_axi_bresp	({roc__axi_bresp,dat_ram_axi_bresp}), // Templated
		  .dst_axi_bvalid	({roc__axi_bvalid,dat_ram_axi_bvalid}), // Templated
		  .dst_axi_arready	({roc__axi_arready,dat_ram_axi_arready,dat_rom_axi_arready}), // Templated
		  .dst_axi_rdata	({roc__axi_rdata,dat_ram_axi_rdata,dat_rom_axi_rdata}), // Templated
		  .dst_axi_rresp	({roc__axi_rresp,dat_ram_axi_rresp,dat_rom_axi_rresp}), // Templated
		  .dst_axi_rvalid	({roc__axi_rvalid,dat_ram_axi_rvalid,dat_rom_axi_rvalid})); // Templated
         

   assign dat_intf_wr_decode[2] = !(dat_intf_wr_decode[1] | dat_intf_wr_decode[0]);   // Error
   assign dat_intf_wr_decode[1] = (dat_axi_awaddr >= ROC_START)  && (dat_axi_awaddr < ROC_STOP);   
   ...
   assign dat_intf_rd_decode[2] = (dat_axi_araddr >= ROC_START)  && (dat_axi_araddr < ROC_STOP);
