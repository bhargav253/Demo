...
module axil_reg
  ...
  #(
   ...
   output logic [DataWidth-1:0]    reg_wdata_o;
   output logic [StrbWidth-1:0]    reg_be_o;
   output logic                    reg_ren_o;
   output logic                    reg_wen_o;
   output logic [RegAddrWidth-1:0] reg_addr_o;
   input  logic                    reg_busy_i;
   input  logic [DataWidth-1:0]    reg_rdata_i;
   ...
   assign reg_addr_o   = axi_arvalid_i ? axi_arreq_i.araddr[RegAddrWidth-1:0] : axi_awreq_i.awaddr[RegAddrWidth-1:0];
